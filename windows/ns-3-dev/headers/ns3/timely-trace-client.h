...
#ifndef TIMELY_TRACE_CLIENT_H
#define TIMELY_TRACE_CLIENT_H
 ...
 */
class TimelyTraceClient : public Application
{
public:
  static TypeId
  GetTypeId (void);
  ...
  TimelyTraceClient (Ipv4Address ip, uint16_t port, char *traceFile);
  ~TimelyTraceClient ();
